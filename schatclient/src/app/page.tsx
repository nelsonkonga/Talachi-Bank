        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="#" className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-lg font-bold text-lg hover:bg-white/20 transition-all flex items-center justify-center">
                View Documentation
              </Link>
            </div>
          </div>
